...
%-------------Pregunta 10-------------------------------------------
    ...
    Como no hay exceso de implicantes entonces:\\
    $X = Pl1 + Pl2 + Pl3 + Pl4$\\
    Sustituimos por sus valores decimales:\\
    $X = (0,2) + (2,6) + (9,25) + (23,3)$\\
    Sustituimos por sus valores binarios:\\
    $X = (000-0) + (00-10) + (-1001) + (1-111)$\\
    Sustituimos por sus valores $x_{i}$:\\
    $X = \overline{x_0 x_1 x_2 x_4} + \overline{x_0 x_1}x_3\overline{x_4} + x_1\overline{x_2 x_3}x_4 + x_0 x_2 x_3 x_4$\\
    $\therefore$ La expresión reducida es: \\
    $\overline{x_0 x_1 x_2 x_4} + \overline{x_0 x_1}x_3\overline{x_4} + x_1\overline{x_2 x_3}x_4 + x_0 x_2 x_3 x_4$\\
%-------------Pregunta 11-------------------------------------------
